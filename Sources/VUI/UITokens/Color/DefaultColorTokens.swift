...
public extension ColorTokens {
    ...
    var onSecondary: Color { .init(white: 100) }
    ...
    var onTertiary: Color { .init(white: 100) }
    ...
    var onError: Color { .init(white: 100) }
    ...
    var onWarning: Color { .init(white: 100) }
    ...
    var onSuccess: Color { .init(white: 100) }
    ...
    var surfaceContainerLowest: Color { .init(white: 100) }
    ...
    var scrim: Color { .init(white: 0) }
    
    var shadow: Color { .init(white: 0) }
}
